...
While there are, and have been, technologies to deploy libraries without redeploying the applications they comprise (consider [OSGi](https://www.osgi.org/)), it seems the level of effort required to use these tecnologies has so far outweighed their potential benefits. At least until now...
